...
5. A single GitHub token (fine-grained personal access token) with sufficient permissions will be configured. A secret named `SDK_AUTOMATION_TOKEN` will be used to store it.
